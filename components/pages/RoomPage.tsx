          ...
          <div className=''>
            {scores.map((score, index) => (
              <motion.div
                ...
                className={`relative flex items-center justify-between p-2 shadow mb-2 transform skew-x-[-10deg] rounded-xl ${index === 0 || scores[index - 1] === 0 && scores[index - 1] ? 'bg-yellow-400' : 'bg-yellow-400/50'}`}
              >
                {index === 0 || scores[index - 1] === 0 ? (
                  <>
