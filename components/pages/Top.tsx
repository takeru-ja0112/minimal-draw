...
import { getIcon, getUserId, getUsername, setIcon, setUsernameSchema } from '@/lib/user';
...
export default function Top() {
  ...
  return (
    <>
      <div className="min-w-[320px] flex items-center justify-center px-8 overflow-hidden">
        <div className="">
          <TutorialHelpButton id="tutorial-step-reset" tutorialKey="top" className="absolute top-20 left-5" />
        </div>
        <div className="max-w-2xl w-90 mt-10 mb-30 z-10">
          ...
          >
            {/* タイトル - 3D効果 */}
            <motion.h1 className={`${schoolbell.className} text-foreground text-3xl font-bold`}>{title}</motion.h1>
          </motion.div>
          ...
          >
            <Card className="mt-10 text-center">
              ...
              <p className="text-gray-600">このゲームはアカウントログイン不要の完全無料で遊ぶ事ができます！</p>
            </Card>
          </motion.div>
          <div className="mt-10">
            {/* メインボタン */}
